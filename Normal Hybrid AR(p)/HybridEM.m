function [R_EM,Q_EM,L_EM] = HybridEM(y,p,P0,maxIter,Rstart,Qstart,fs,exp_smoothing,tol)
...
Q(:,:,j); %%%% Uncomment in case monitoring of covariance matrix is desired
    %% E-Step
    [a,E,Psmooth,Ppreds,H,S]=HybridKalmanEM(y,p,P0,R(j),Q(:,:,j),fs,exp_smoothing); 
